    ...
    <tbody>
           <?php foreach($obtner_todos as $operaciones){?>
                   <tr>
                    ...
                    <td>
                        <button class="btn btn-warning" onclick="editar(<?php echo $operaciones->cat_operaciones_id;?>)"><i class="fa fa-pencil" aria-hidden="true"></i></button>
                        <button class="btn btn-danger" onclick="eliminar(<?php echo $operaciones->cat_operaciones_id;?>)"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                    </td >
                    </tr>
           <?php }?>
    </tbody>
...
function save()
  {
    ...
    {
      url = "<?php echo site_url('operaciones/actualizar_operacion')?>";
    }
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form action="#" id="form" class="form-horizontal">
        <input type="hidden" value="" name="cat_operaciones_id"/>
        <div class="form-body">
